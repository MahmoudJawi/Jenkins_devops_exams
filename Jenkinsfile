            ...
            steps {
                script {
                    sh '''
                        ...
                        docker run -d -p 8005:80 --name ci-movie-api $DOCKER_ID/$DOCKER_IMAGE_MOVIE:$DOCKER_TAG
                        docker run -d -p 8006:80 --name ci-cast-api $DOCKER_ID/$DOCKER_IMAGE_CAST:$DOCKER_TAG
                        sleep 10
                    '''
                }
            }
